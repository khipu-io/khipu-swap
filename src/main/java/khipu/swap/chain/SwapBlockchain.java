...
public class SwapBlockchain implements MutableBlockchain {
  ...
  public static MutableBlockchain createMutable(
      ...
      final MetricsSystem metricsSystem) {
    checkNotNull(genesisBlock);
    return new SwapBlockchain(Optional.of(genesisBlock), blockchainStorage, metricsSystem);
  }
  ...
  public static Blockchain create(
    ...
    return new SwapBlockchain(Optional.empty(), blockchainStorage, metricsSystem);
  }
